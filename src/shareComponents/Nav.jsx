            ...
            <div className="navbar bg-[#0a2233] text-white">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box text-blue-500 w-52">
                            <NavLink to={'/'}>Home</NavLink>
                            <NavLink to={'/AllTourists'}>All Tourists Spot</NavLink>
                            <NavLink to={'/TouristsSpot'}>Add Tourists Spot</NavLink>
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal space-x-10 px-1">
                        <NavLink to={'/'}>Home</NavLink>
                        <NavLink to={'/AllTourists'}>All Tourists Spot</NavLink>
                        <NavLink to={'/TouristsSpot'}>Add Tourists Spot</NavLink>
                        <NavLink to={'/List'}>My List</NavLink>
                ...
                <div className="navbar-end space-x-5">
                    ...
                    <label className="swap swap-rotate">
                        ...
                        <input onChange={themeController} type="checkbox" className="theme-controller" checked={theme === 'light' ? false : true} />
